...
DECLARE_SEGMENT(segment_01136000);
...
DECLARE_SEGMENT(m_random_field_ovl);
...
DECLARE_SEGMENT(act_ball_b);
DECLARE_SEGMENT(act_ball_d);
DECLARE_SEGMENT(act_ball_s);
...
DECLARE_SEGMENT(object_017A1000);
DECLARE_SEGMENT(object_0182A000);
DECLARE_SEGMENT(segment_013E7000);
