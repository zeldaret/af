...
void mSc_regist_initial_exchange_bank(struct Game_Play* gamePlay);
// void func_800C62C4_jp();
void mSc_dmacopy_all_exchange_bank(struct Game_Play_unk_0110* arg0);
void mSc_data_bank_ct(struct Game_Play* gamePlay, struct Game_Play_unk_0110* arg1);
void mSc_decide_exchange_bank(struct Game_Play_unk_0110* arg0);
// void func_800C6690_jp();
void Scene_ct(struct Game_Play* gamePlay, void* arg1);
