...
typedef struct Private_c {
    ...
    /* 0x014 */ struct {
        /* 0x014 */ mActor_name_t pockets[mPr_POCKETS_SLOT_COUNT]; /* items in inventory */
        /* 0x032 */ u8 lotto_ticket_expiry_month;
        /* 0x033 */ u8 lotto_ticket_mail_storage;
        /* 0x034 */ u32 item_conditions; /* bitfield (15 values), 2 bits per pocket slot */
        /* 0x038 */ u32 wallet;
        /* 0x03C */ u32 loan;
    } inventory;
