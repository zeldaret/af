...
typedef s32 (*DrawCallback)(struct Game_Play* play, SkeletonInfoR* skeletonInfo, s32 jointIndex, Gfx** dlist, u8* displayBufferFlag, void*, Vec3s* rotation, Vec3f* translation);
...
void cKF_Si3_draw_SV_R_child(struct Game_Play* play, SkeletonInfoR* skeletonInfo, s32* jointIndex,
                             DrawCallback beforeCallback, DrawCallback afterCallback, void* arg, Mtx** mtx);
void cKF_Si3_draw_R_SV(struct Game_Play* play, SkeletonInfoR* skeletonInfo, Mtx* mtx, DrawCallback beforeCallback,
