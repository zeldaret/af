...
void Global_kankyo_ct(struct Game_Play* play, struct Kankyo* kankyo);
...
void Global_kankyo_set(struct Game_Play* play, struct Kankyo* kankyo, struct LightContext* arg2);
