...
typedef void (*ActorFunc)(struct Actor* this, struct Game_Play* play);
...
void projection_pos_set(struct Game_Play* play, Vec3f* worldPos, Vec3f* projectedPos, f32* invW);
...
s32 Actor_player_look_direction_check(Actor* actor, s16 maxAngleDiff, struct Game_Play* play);
void Actor_display_position_set(struct Game_Play* play, Actor* actor, s16* x, s16* y);
...
void Actor_delete_check(Actor* actor, struct Game_Play* play);
void Actor_info_ct(struct Game_Play* play2, ActorInfo* actorInfo, struct ActorEntry* actorEntry);
void Actor_info_dt(ActorInfo* actorInfo, struct Game_Play* play);
void Actor_info_call_actor(struct Game_Play* play, ActorInfo* actorInfo);
void Actor_info_draw_actor(struct Game_Play* play, ActorInfo* actorInfo);
...
void Actor_init_actor_class(Actor* actor, ActorProfile* profile, struct ActorOverlay* overlayEntry, struct Game_Play* play, s32 arg4, f32 x, f32 y, f32 z, s16 rotX, s16 rotY, s16 rotZ, s8 argB, s8 argC, s16 argD, u16 fgName, s16 params);
Actor* Actor_info_make_actor(ActorInfo* actorInfo, struct Game_Play* play, s16 actorId, f32 x, f32 y, f32 z, s16 rotX, s16 rotY, s16 rotZ, s8 arg9, s8 argA, s16 argB, u16 fgName, s16 params, s8 argE, s32 argF);
Actor* Actor_info_make_child_actor(ActorInfo* actorInfo, Actor* arg1, struct Game_Play* play, s16 actorId, f32 x, f32 y, f32 z, s16 rotX, s16 rotY, s16 rotZ, s16 argA, u16 fgName, s16 params, s32 argD);
void restore_fgdata(Actor* actor, struct Game_Play* play);
void restore_fgdata_one(Actor* actor, struct Game_Play* play);
void restore_fgdata_all(struct Game_Play* play);
void Actor_info_save_actor(struct Game_Play* play);
Actor* Actor_info_delete(ActorInfo* actorInfo, Actor* actor, struct Game_Play* play);
...
Hilite* Setpos_HiliteReflect_init(Vec3f* object, struct Game_Play* play);
Hilite* Setpos_HiliteReflect_xlu_init(Vec3f* object, struct Game_Play* play);
Hilite* Setpos_HiliteReflect_light_init(Vec3f* object, struct Game_Play* play);
