...
//     // void *temp_v0_8;
//     // void *temp_v0_9;
//     Mtx* mtx = this->matrix[game_play->state.unk_A0 & 1];
...
//     gDPSetTile(__polyOpa++, G_IM_FMT_RGBA, G_IM_SIZ_4b, 0, 0x01F0, G_TX_LOADTILE, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMASK, G_TX_NOLOD, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMASK, G_TX_NOLOD);
...
//     gDPLoadTLUTCmd(__polyOpa++, G_TX_LOADTILE, 15);
