...
void aNEG_actor_ct(Actor* thisx, Game_Play* play);
void aNEG_actor_dt(Actor* thisx, Game_Play* play);
void aNEG_actor_init(Actor* thisx, Game_Play* play);
void aNEG_actor_save(Actor* thisx, Game_Play* play);
