...
void func_805ac0ac(Actor* thisx, Game_Play* play);
void func_805ac120(Actor* thisx, Game_Play* play);
void func_805ac5ec(Actor* thisx, Game_Play* play);
void func_805ac7b0(Actor* thisx, Game_Play* play);
