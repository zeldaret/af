...
void Bg_Draw_Actor_ct(Actor* thisx, Game_Play* gamePlay);
void Bg_Draw_Actor_dt(Actor* thisx, Game_Play* gamePlay);
void Bg_Draw_Actor_move(Actor* thisx, Game_Play* gamePlay);
void Bg_Draw_Actor_draw(Actor* thisx, Game_Play* gamePlay);
