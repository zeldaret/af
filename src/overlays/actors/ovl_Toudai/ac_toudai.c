...
void aTOU_setup_action(Toudai* this, s32 arg1);
...
UNK_TYPE aTOU_shadow_data[] = { 0x00000014, aTOU_shadow_vtx_fix_flg_table, 0x42700000, 0x060089C8,
                                0x06008B08 };             // obj_s_toudai_shadow_v, obj_s_toudai_shadow_1_model
static BaseSkeletonR* skl[] = { 0x0607EE1C, 0x06080A24 }; // cKF_bs_r_obj_s_toudai, cKF_bs_r_obj_w_toudai
mCoBG_OffsetTable height_table_ct[] = { { 0x64, 0x10, 0x10, 0x10, 0x10, 0x10, 0x00 },
                                        { 0x64, 0x10, 0x10, 0x10, 0x10, 0x10, 0x00 },
                                        { 0x64, 0x10, 0x10, 0x10, 0x10, 0x10, 0x00 },
                                        { 0x64, 0x10, 0x10, 0x10, 0x10, 0x10, 0x00 } };
...
void aTOU_lighting(Toudai* this, PlayState* play UNUSED) {
    // m_common_data::common_data.time.now_sec
    // TODO write time struct in commondata
    if ((common_data.unk10118 < 0xFD20) && (common_data.unk10118 >= 0x4650)) {
...
//         sp2C = temp_a3;
//         sp18 = _Matrix_to_Mtx_new(play->state.gfxCtx);
//         // sp18 = temp_v0;
//         if (temp_v0 != NULL) {
//             sp24 = common_data.season == 3;
//             sp20 = common_data.structureClip->unk_AC(0x2DU);
//             sp1C = common_data.structureClip->getPalSegment(0x5AU);
//             func_800BD5C0_jp(play->state.gfxCtx);
//             temp_v0_2 = sp2C->light.tha.head;
//             temp_v0_2->unk0 = 0xDB060020;
//             temp_v0_3 = temp_v0_2 + 8;
//             temp_v0_2->unk4 = sp1C;
//             temp_v0_3->unk0 = 0xDB060018;
//             temp_v0_4 = temp_v0_3 + 8;
//             temp_v0_3->unk4 = sp20;
//             temp_a2 = (u32)arg5->unk2C8 & 0xFF;
//             var_a0 = (u32)arg5->unk2CC & 0xFF;
//             temp_v1 = (u32)arg5->unk2D0;
//             if ((temp_v1 & 0xFF) < var_a0) {
//                 var_a0 = temp_v1 & 0xFF;
//             }
...
//             temp_v0_5->unk0 = (s32)(((u32)arg5->unk2D0 & 0xFF) | 0xFA000000);
//             temp_v0_5->unk4 =
//                 (s32)((prmcol.r << 0x18) | ((D_80AAC109 & 0xFF) << 0x10) | ((temp_a2 & 0xFF) << 8) | (var_a0 & 0xFF));
//             D_80AAC10B = var_a0;
//             D_80AAC10B = temp_a2;
//             temp_v0_6->unk0 = 0xDA380003;
//             temp_v0_7 = temp_v0_6 + 8;
//             temp_v0_6->unk4 = sp18;
//             temp_v0_7->unk0 = 0xDE000000;
//             temp_v0_7->unk4 = (Gfx*)mdl[sp24];
//             sp2C->light.tha.head = temp_v0_7 + 8;
//         }
//     }
