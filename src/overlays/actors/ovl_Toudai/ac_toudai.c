...
void aTOU_actor_ct(Actor* thisx, Game_Play* game_play UNUSED) {
    ...
    gSegments[6] = OS_K0_TO_PHYSICAL(common_data.clip.unk_10098->unk_AC(45));
...
void aTOU_actor_dt(Actor* thisx, Game_Play* game_play UNUSED) {
    ...
    common_data.clip.unk_10098->unk_A8(&common_data.clip.unk_10098->unk_B0, 8, 45, thisx);
    common_data.clip.unk_10098->unk_A8(&common_data.clip.unk_10098->unk_454, 9, 90, thisx);
    common_data.clip.unk_10098->unk_A8(&common_data.clip.unk_10098->unk_86C, 8, 45, thisx);
...
s32 aTOU_actor_draw_after(Game_Play* game_play, SkeletonInfoR* skeletonInfo UNUSED, s32 jointIndex, Gfx** dlist UNUSED,
    ...
    if ((jointIndex == 4) && ((s32)this->unk2CC)) {
        ...
        if (mtx != NULL) {
            ...
            object = common_data.clip.unk_10098->unk_AC(0x2D);
            palette = common_data.clip.unk_10098->unk_450(0x5A);
...
void aTOU_actor_draw(Actor* thisx, Game_Play* game_play) {
    ...
    if (mtx != NULL) {
        ...
        common_data.clip.unk_10080->unk_04(game_play, &aTOU_shadow_data, 0x2D);
    }
}
