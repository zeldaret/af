...
void BoxTrick01_Actor_ct(Actor* thisx, Game_Play* gamePlay);
void BoxTrick01_Actor_dt(Actor* thisx, Game_Play* gamePlay);
void BoxTrick01_Actor_move(Actor* thisx, Game_Play* gamePlay);
