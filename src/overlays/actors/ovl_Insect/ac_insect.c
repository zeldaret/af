...
void aINS_actor_dt(Actor* thisx, Game_Play* game_play);
void aINS_actor_move(Actor* thisx, Game_Play* game_play);
void aINS_actor_draw(Actor* thisx, Game_Play* game_play);
