...
void Shop_Goods_Actor_dt(Actor* thisx, Game_Play* game_play);
void Shop_Goods_Actor_move(Actor* thisx, Game_Play* game_play);
void Shop_Goods_Actor_draw(Actor* thisx, Game_Play* game_play);
