...
void aECPD_actor_ct(Actor* thisx, Game_Play* gamePlay);
void aECPD_actor_dt(Actor* thisx, Game_Play* gamePlay);
void aECPD_actor_init(Actor* thisx, Game_Play* gamePlay);
void aECPD_actor_save(Actor* thisx, Game_Play* gamePlay);
