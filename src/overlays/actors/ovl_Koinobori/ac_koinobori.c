...
void aKOI_actor_ct(Actor* thisx, Game_Play* game_play UNUSED) {
    ...
    gSegments[6] = OS_K0_TO_PHYSICAL(common_data.clip.unk_10098->unk_AC(0x27));
...
void aKOI_actor_dt(Actor* thisx, Game_Play* game_play UNUSED) {
    ...
    common_data.clip.unk_10098->unk_A8(&common_data.clip.unk_10098->unk_B0, 8, 0x27, &this->actor);
    common_data.clip.unk_10098->unk_A8(&common_data.clip.unk_10098->unk_454, 9, 0x50, &this->actor);
    common_data.clip.unk_10098->unk_A8(&common_data.clip.unk_10098->unk_86C, 8, 0x27, &this->actor);
...
void aKOI_actor_draw(Actor* thisx, Game_Play* game_play) {
    ...
    if (mtx != NULL) {
        object = common_data.clip.unk_10098->unk_AC(0x27);
        palette = common_data.clip.unk_10098->unk_450(0x50);
        ...
        common_data.clip.unk_10080->unk_04(game_play, &aKOI_shadow_data, 0x27);
    }
}
