...
void aTKN0_actor_ct(Actor* thisx, PlayState* play);
void aTKN0_actor_dt(Actor* thisx, PlayState* play);
void aTKN0_actor_init(Actor* thisx, PlayState* play);
void aTKN0_actor_save(Actor* thisx, PlayState* play);
