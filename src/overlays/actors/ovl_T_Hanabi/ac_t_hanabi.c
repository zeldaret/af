...
void aTHB_actor_ct(Actor* thisx, Game_Play* gamePlay);
void aTHB_actor_dt(Actor* thisx, Game_Play* gamePlay);
void aTHB_actor_move(Actor* thisx, Game_Play* gamePlay);
void aTHB_actor_draw(Actor* thisx, Game_Play* gamePlay);
