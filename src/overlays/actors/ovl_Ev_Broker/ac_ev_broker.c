...
void aEBRK_actor_ct(Actor* thisx, PlayState* play);
void aEBRK_actor_dt(Actor* thisx, PlayState* play);
void aEBRK_actor_init(Actor* thisx, PlayState* play);
void aEBRK_actor_save(Actor* thisx, PlayState* play);
