...
void aSTA_actor_dt(Actor* thisx, Game_Play* game_play);
void aSTA_actor_init(Actor* thisx, Game_Play* game_play);
void aSTA_actor_draw(Actor* thisx, Game_Play* game_play);
