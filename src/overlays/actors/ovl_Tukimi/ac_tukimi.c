...
void aTUK_actor_ct(Actor* thisx, PlayState* play);
void aTUK_actor_dt(Actor* thisx, PlayState* play);
void aTUK_actor_init(Actor* thisx, PlayState* play);
void aTUK_actor_draw(Actor* thisx, PlayState* play);
