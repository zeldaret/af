...
void aTUK_actor_ct(Actor* thisx, Game_Play* play);
void aTUK_actor_dt(Actor* thisx, Game_Play* play);
void aTUK_actor_init(Actor* thisx, Game_Play* play);
void aTUK_actor_draw(Actor* thisx, Game_Play* play);
