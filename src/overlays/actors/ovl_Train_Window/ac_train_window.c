...
void Train_Window_Actor_ct(Actor* thisx, Game_Play* gamePlay);
void Train_Window_Actor_dt(Actor* thisx, Game_Play* gamePlay);
void Train_Window_Actor_move(Actor* thisx, Game_Play* gamePlay);
void Train_Window_Actor_draw(Actor* thisx, Game_Play* gamePlay);
