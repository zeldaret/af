...
void aPOL2_actor_ct(Actor* thisx, Game_Play* gamePlay);
void aPOL2_actor_dt(Actor* thisx, Game_Play* gamePlay);
void aPOL2_actor_init(Actor* thisx, Game_Play* gamePlay);
void aPOL2_actor_save(Actor* thisx, Game_Play* gamePlay);
