...
void Ef_Room_Sunshine_actor_ct(Actor* thisx, Game_Play* play);
void Ef_Room_SunshineR_actor_move(Actor* thisx, Game_Play* play);
void Ef_Room_SunshineR_actor_draw(Actor* thisx, Game_Play* play);
