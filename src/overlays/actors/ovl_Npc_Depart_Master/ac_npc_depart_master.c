...
void aNDM_actor_ct(Actor* thisx, Game_Play* play);
void aNDM_actor_dt(Actor* thisx, Game_Play* play);
void aNDM_actor_init(Actor* thisx, Game_Play* play);
void aNDM_actor_save(Actor* thisx, Game_Play* play);
