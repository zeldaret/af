...
void aEVD_actor_ct(Actor* thisx, PlayState* play);
void aEVD_actor_dt(Actor* thisx, PlayState* play);
void aEVD_actor_init(Actor* thisx, PlayState* play);
void aEVD_actor_save(Actor* thisx, PlayState* play);
