...
void bXI_actor_ct(Actor* thisx, PlayState* play);
void bXI_actor_dt(Actor* thisx, PlayState* play);
void bXI_actor_move(Actor* thisx, PlayState* play);
void bXI_actor_draw(Actor* thisx, PlayState* play);
