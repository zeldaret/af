...
void aRSV_actor_ct(Actor* thisx, Game_Play* gamePlay);
void func_80A09370_jp(Actor* thisx, Game_Play* gamePlay);
void aRSV_actor_init(Actor* thisx, Game_Play* gamePlay);
void aRSV_actor_draw(Actor* thisx, Game_Play* gamePlay);
