...
void aMJN4_actor_ct(Actor* thisx, PlayState* play);
void aMJN4_actor_dt(Actor* thisx, PlayState* play);
void aMJN4_actor_init(Actor* thisx, PlayState* play);
void aMJN4_actor_save(Actor* thisx, PlayState* play);
