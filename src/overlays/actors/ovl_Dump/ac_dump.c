...
void aDUM_actor_ct(Actor* thisx, Game_Play* play);
void aDUM_actor_dt(Actor* thisx, Game_Play* play);
void aDUM_actor_init(Actor* thisx, Game_Play* play);
void aDUM_actor_draw(Actor* thisx, Game_Play* play);
