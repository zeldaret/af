...
void aEMK_actor_ct(Actor* thisx, Game_Play* gamePlay);
void aEMK_actor_dt(Actor* thisx, Game_Play* gamePlay);
void aEMK_actor_init(Actor* thisx, Game_Play* gamePlay);
void aEMK_actor_save(Actor* thisx, Game_Play* gamePlay);
