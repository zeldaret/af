...
void Ef_Room_Sunshine_Posthouse_actor_ct(Actor* thisx, Game_Play* play);
void Ef_Room_Sunshine_PosthouseR_actor_move(Actor* thisx, Game_Play* play);
void Ef_Room_Sunshine_PosthouseR_actor_draw(Actor* thisx, Game_Play* play);
