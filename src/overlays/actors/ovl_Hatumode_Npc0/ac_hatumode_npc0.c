...
void func_8052ab54(Actor* thisx, Game_Play* play);
void func_8052ac90(Actor* thisx, Game_Play* play);
void func_8052ad14(Actor* thisx, Game_Play* play);
void func_8052ac70(Actor* thisx, Game_Play* play);
