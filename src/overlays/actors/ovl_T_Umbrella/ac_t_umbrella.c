...
void aTUMB_actor_ct(Actor* thisx, Game_Play* gamePlay);
void aTUMB_actor_move(Actor* thisx, Game_Play* gamePlay);
void aTUMB_actor_draw(Actor* thisx, Game_Play* gamePlay);
