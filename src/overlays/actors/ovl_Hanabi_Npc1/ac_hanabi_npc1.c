...
void aHN1_actor_ct(Actor* thisx, Game_Play* play);
void aHN1_actor_dt(Actor* thisx, Game_Play* play);
void aHN1_actor_init(Actor* thisx, Game_Play* play);
void aHN1_actor_save(Actor* thisx, Game_Play* play);
