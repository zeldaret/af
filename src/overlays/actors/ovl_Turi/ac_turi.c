...
void aTUR_actor_ct(Actor* thisx, Game_Play* play);
void aTUR_actor_dt(Actor* thisx, Game_Play* play);
void aTUR_actor_init(Actor* thisx, Game_Play* play);
void aTUR_actor_draw(Actor* thisx, Game_Play* play);
