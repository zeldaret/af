...
void aEDZ_actor_ct(Actor* thisx, Game_Play* play);
void aEDZ_actor_dt(Actor* thisx, Game_Play* play);
void aEDZ_actor_init(Actor* thisx, Game_Play* play);
void aEDZ_actor_save(Actor* thisx, Game_Play* play);
