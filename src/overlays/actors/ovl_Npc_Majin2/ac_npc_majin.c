...
void aMJN2_actor_dt(Actor* thisx, Game_Play* game_play);
void aMJN2_actor_init(Actor* thisx, Game_Play* game_play);
void aMJN2_actor_save(Actor* thisx, Game_Play* game_play);
