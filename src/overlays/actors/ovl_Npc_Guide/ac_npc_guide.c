...
void aNGD_actor_ct(Actor* thisx, PlayState* play);
void aNGD_actor_dt(Actor* thisx, PlayState* play);
void aNGD_actor_init(Actor* thisx, PlayState* play);
void aNGD_actor_save(Actor* thisx, PlayState* play);
