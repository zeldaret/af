...
void func_80A05D50_jp(Actor* thisx, Game_Play* play);
void func_80A05F88_jp(Actor* thisx, Game_Play* play);
void func_80A06DF0_jp(Actor* thisx, Game_Play* play);
void func_80A071A0_jp(Actor* thisx, Game_Play* play);
