...
void Shop_Umbrella_Actor_ct(Actor* thisx, Game_Play* gamePlay);
void Shop_Umbrella_Actor_dt(Actor* thisx, Game_Play* gamePlay);
void Shop_Umbrella_Actor_move(Actor* thisx, Game_Play* gamePlay);
void Shop_Umbrella_Actor_draw(Actor* thisx, Game_Play* gamePlay);
