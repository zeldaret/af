...
void aNCM_actor_ct(Actor* thisx, PlayState* play);
void aNCM_actor_dt(Actor* thisx, PlayState* play);
void aNCM_actor_init(Actor* thisx, PlayState* play);
void aNCM_actor_save(Actor* thisx, PlayState* play);
