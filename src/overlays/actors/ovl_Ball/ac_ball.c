...
void aBALL_actor_ct(Actor* thisx, Game_Play* play);
void aBALL_actor_dt(Actor* thisx, Game_Play* play);
void aBALL_actor_move(Actor* thisx, Game_Play* play);
void aBALL_actor_draw(Actor* thisx, Game_Play* play);
