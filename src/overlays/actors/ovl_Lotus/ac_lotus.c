...
void aLOT_actor_ct(Actor* thisx, Game_Play* gamePlay);
void aLOT_actor_dt(Actor* thisx, Game_Play* gamePlay);
void aLOT_actor_init(Actor* thisx, Game_Play* gamePlay);
void aLOT_actor_draw(Actor* thisx, Game_Play* gamePlay);
