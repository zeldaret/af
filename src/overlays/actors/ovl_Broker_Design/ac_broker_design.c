...
void Broker_Design_Actor_dt(Actor* thisx, Game_Play* game_play);
void Broker_Design_Actor_move(Actor* thisx, Game_Play* game_play);
void Broker_Design_Actor_draw(Actor* thisx, Game_Play* game_play);
