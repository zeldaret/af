...
void func_80A9C3C0_jp(Actor* thisx, Game_Play* play);
void aWIN_actor_dt(Actor* thisx, Game_Play* play);
void aWIN_actor_init(Actor* thisx, Game_Play* play);
void aWIN_actor_draw(Actor* thisx, Game_Play* play);
