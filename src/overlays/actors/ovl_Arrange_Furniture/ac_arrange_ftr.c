...
void Arrange_Furniture_Actor_ct(Actor* thisx, Game_Play* play);
void Arrange_Furniture_Actor_dt(Actor* thisx, Game_Play* play);
void Arrange_Furniture_Actor_move(Actor* thisx, Game_Play* play);
void Arrange_Furniture_Actor_draw(Actor* thisx, Game_Play* play);
