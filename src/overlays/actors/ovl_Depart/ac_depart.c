...
void aDPT_actor_dt(Actor* thisx, Game_Play* game_play);
void aDPT_actor_init(Actor* thisx, Game_Play* game_play);
void aDPT_actor_draw(Actor* thisx, Game_Play* game_play);
