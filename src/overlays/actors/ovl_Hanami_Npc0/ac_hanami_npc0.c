...
void func_809DE5DC_jp(Hanami_Npc0* this, s32 index) {
    static Hanami_Npc0_unk_93C D_809DEB0C_jp[] = { func_809DE538_jp, func_809DE56C_jp, func_809DE5BC_jp };
...
void func_809DE830_jp(Hanami_Npc0* this, Game_Play* game_play) {
    static s16 D_809DEB54_jp[4] = { 0x2000, 0xC000, 0xE000, 0x4000 };
...
void func_809DE978_jp(Actor* thisx) {
    static u32 D_809DEB64_jp[] = { 0x0000192D, 0x0000193C, 0x0000191E, 0x0000194B, 0x0000195A, 0x00001969 };
    Hanami_Npc0* this = THIS;
