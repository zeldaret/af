...
void aNRG2_actor_ct(Actor* thisx, PlayState* play);
void aNRG2_actor_dt(Actor* thisx, PlayState* play);
void aNRG2_actor_init(Actor* thisx, PlayState* play);
void aNRG2_actor_save(Actor* thisx, PlayState* play);
