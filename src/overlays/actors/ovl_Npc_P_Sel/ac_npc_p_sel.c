...
void aNPS_actor_dt(Actor* thisx, Game_Play* game_play);
void aNPS_actor_init(Actor* thisx, Game_Play* game_play);
void aNPS_actor_save(Actor* thisx, Game_Play* game_play);
