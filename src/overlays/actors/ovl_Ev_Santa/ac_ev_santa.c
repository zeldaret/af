...
void aESNT_actor_ct(Actor* thisx, Game_Play* play);
void aESNT_actor_dt(Actor* thisx, Game_Play* play);
void aESNT_actor_init(Actor* thisx, Game_Play* play);
void aESNT_actor_save(Actor* thisx, Game_Play* play);
