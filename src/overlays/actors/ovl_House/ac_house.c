...
void aHUS_actor_ct(Actor* thisx, Game_Play* gamePlay);
void aHUS_actor_dt(Actor* thisx, Game_Play* gamePlay);
void aHUS_actor_init(Actor* thisx, Game_Play* gamePlay);
void aHUS_actor_draw(Actor* thisx, Game_Play* gamePlay);
