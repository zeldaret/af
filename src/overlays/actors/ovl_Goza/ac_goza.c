...
void aGOZ_actor_ct(Actor* thisx, Game_Play* play);
void func_80A76208_jp(Actor* thisx, Game_Play* play);
void aGOZ_actor_init(Actor* thisx, Game_Play* play);
void aGOZ_actor_draw(Actor* thisx, Game_Play* play);
