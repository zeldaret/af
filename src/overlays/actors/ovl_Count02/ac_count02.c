...
void func_805ab988(Actor* thisx, Game_Play* game_play);
void func_805abdac(Actor* thisx, Game_Play* game_play);
void func_805abe88(Actor* thisx, Game_Play* game_play);
