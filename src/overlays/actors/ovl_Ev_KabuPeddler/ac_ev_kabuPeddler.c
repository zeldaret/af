...
void aEKPD_actor_ct(Actor* thisx, Game_Play* gamePlay);
void aEKPD_actor_dt(Actor* thisx, Game_Play* gamePlay);
void aEKPD_actor_init(Actor* thisx, Game_Play* gamePlay);
void aEKPD_actor_save(Actor* thisx, Game_Play* gamePlay);
