...
void func_80A034A0_jp(Actor* thisx, Game_Play* play);
void func_80A034B0_jp(Actor* thisx, Game_Play* play);
void aFLEW_actor_move(Actor* thisx, Game_Play* play);
void aFLEW_actor_draw(Actor* thisx, Game_Play* play);
...
#pragma GLOBAL_ASM("asm/jp/nonmatchings/overlays/actors/ovl_FallSESW/ac_fallSESW/D_80A03528_jp.s")
