...
void aMJN_actor_ct(Actor* thisx, PlayState* play);
void aMJN_actor_dt(Actor* thisx, PlayState* play);
void aMJN_actor_init(Actor* thisx, PlayState* play);
void aMJN_actor_save(Actor* thisx, PlayState* play);
